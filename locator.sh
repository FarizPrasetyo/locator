#!/bin/bash
# Locator v1.0
# Coded by: Twitster (You dont become a coder by just changing the credits)
# Github: https://github.com/prasetyox/locator
...
printf "\n"
printf "\e[1;93m :::\e[0m\e[1;77m Coded by: Twitster\e[0m\n"
